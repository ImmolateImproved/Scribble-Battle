...
namespace DI
{
    public class DIContainer
    {
        ...
        public void RegisterInstance<T>(string tag, T instance)
        {
            ...
            {
                throw new Exception($"DI factory with tag {key.Item1} and type {key.Item2.FullName} has already registrated");
            }
        ...
        public T Resolve<T>(string tag = null)
        {
            ...
            {
                throw new Exception($"Cyclic dependency for tag ${tag} and tpye {key.Item2.FullName}");
            }
